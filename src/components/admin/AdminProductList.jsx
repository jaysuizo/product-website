                ...
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-2 text-xs font-semibold text-slate-500">
                      {product.categoryLabel || product.category} | {product.price ? formatCurrency(product.price) : "No price"} | {getProductStock(product)} stock | {product.variants.length} variants | {availabilityLabel[availability] || availabilityLabel.in_stock}
                    </p>
                  </div>
